...
class _AnomalDectionScorer(_BaseScorer):
    def _score(self, method_caller, estimator, X, y_true, sample_weight=None):
        """Evaluate estimator's anomaly detection ability on X.
        ...
        y_true : array-like
            Gold standard target values for X, reserved for future
        ...
        -------
        score : diction
            Score function applied to anomaly detection of estimator on X.
        """

        return self._score_func(estimator, X, y_true)
