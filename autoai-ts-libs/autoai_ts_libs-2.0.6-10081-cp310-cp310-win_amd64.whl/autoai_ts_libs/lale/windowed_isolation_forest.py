...
from autoai_ts_libs.anomaly_detection.estimators.watson_ts.window_ad  import (  # type: ignore # noqa
    WindowedIsolationForest as model_to_be_wrapped,
)
...
class _WindowedIsolationForestImpl:
    def __init__(
        self,
        steps=None,
        *,
            ...
            steps = [
                ...
                (
                    ...
                    GeneralizedAnomalyModel(
                        base_learner=IsolationForest(random_state=RANDOM_STATE),
                        fit_function="fit",
...
.. _`autoai_ts_libs`: https://pypi.org/project/autoai-ts-libs""",
    "documentation_url": "https://lale-autoai.readthedocs.io/en/latest/modules/lale_autoai.autoai_ts_libs.windowed_isolation_forest.html",
...
WindowedIsolationForest = lale.operators.make_operator(
    _WindowedIsolationForestImpl, _combined_schemas
)
lale.docstrings.set_docstrings(WindowedIsolationForest)
