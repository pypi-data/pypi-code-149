...
from autoai_ts_libs.anomaly_detection.estimators.watson_ts.window_ad  import (  # type: ignore # noqa
    WindowedNN as model_to_be_wrapped,
)
            ...
            steps = [
                ...
                (
                    ...
                    GeneralizedAnomalyModel(
                        base_learner=NearestNeighborAnomalyModel(n_neighbors=1),
                        fit_function="fit",
    ...
    "allOf": [
        {
            ...
            "properties": {
                ...
                "lookback_win": get_schema_lookback_win(10),
...
.. _`autoai_ts_libs`: https://pypi.org/project/autoai-ts-libs""",
    "documentation_url": "https://lale-autoai.readthedocs.io/en/latest/modules/lale_autoai.autoai_ts_libs.windowed_nn.html",
...
WindowedNN = lale.operators.make_operator(
    _WindowedNNImpl, _combined_schemas
)
lale.docstrings.set_docstrings(WindowedNN)
