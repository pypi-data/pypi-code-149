...
from ._base import ExtendedBase
...
class ExtendedWindowedIsolationForest(ExtendedBase):
    def __init__(
        self,
        steps=[
            (
    ...
    def get_pipeline_name(self):
        ...
        :return:
        """
        pipeline_name = "ExtendedWindowIsolationForest"
        return pipeline_name


class DSExtendedWindowedIsolationForest(ExtendedBase):
    def __init__(
        self,
        steps=[
            (
    ...
    def get_pipeline_name(self):
        ...
        :return:
        """
        pipeline_name = "DataStationExtendedWindowIsolationForest"
        return pipeline_name
