...
class WatForeADUtils():
            ...
            ###########################################################
                try:
                    ...
                    if per != 1:
                        ...
                        caller_self.all_args['min_training_data'] = len(vals)
                        caller_self.all_args['training_sample_size'] = len(vals)
                    # print('***********',per,caller_self.all_args['training_sample_size'] ,' min training',caller_self.all_args['min_training_data'])
    ...
    def get_regular_season_periodicity(cls, X, wf_context=None, sub_season_percent_delta=0.0,
        ...
        #         wf_context = tspy  # autoai_ts_libs.deps.tspy #TSContext(die_on_exit=False)
            ...
            season_selector = tspy.forecasters.season_selector(sub_season_percent_delta)
