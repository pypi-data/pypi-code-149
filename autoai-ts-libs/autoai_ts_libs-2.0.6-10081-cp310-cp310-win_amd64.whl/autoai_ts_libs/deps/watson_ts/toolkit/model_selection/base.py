...
# Local
from autoai_ts_libs.deps.watson_ts.toolkit.timeseries_conversions import TimeseriesType, to_ndarray
...
class CrossValidator:
    ...
    def split(self, timeseries: TimeseriesType, *args, **kwargs) -> TimeseriesType:
