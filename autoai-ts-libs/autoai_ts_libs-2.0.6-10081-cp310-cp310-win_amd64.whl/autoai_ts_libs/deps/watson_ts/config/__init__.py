...
# First Party
from watson_core import ModelManager
from watson_core.config import Config, compare_versions, get_credentials_or_default
from watson_core.config.catalog import ModelCatalog, ResourceCatalog, WorkflowCatalog
import watson_core
...
MODEL_CATALOG = watson_core.catalog.ModelCatalog(
    {}, lib_config.library_version, lib_config.artifactory_base_path
)
RESOURCE_CATALOG = watson_core.catalog.ResourceCatalog(
    {}, lib_config.library_version, lib_config.artifactory_base_path
)
WORKFLOW_CATALOG = watson_core.catalog.WorkflowCatalog(
    {}, lib_config.library_version, lib_config.artifactory_base_path
)
