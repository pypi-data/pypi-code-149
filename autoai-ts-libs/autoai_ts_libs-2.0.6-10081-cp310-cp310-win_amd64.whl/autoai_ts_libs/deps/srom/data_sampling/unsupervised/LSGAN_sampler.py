...
class LSGAN_MajorityClass_DownSampler(BaseEstimator, TransformerMixin):
    """
    A Least Squares GAN to downsample the majority class. Reference: https://arxiv.org/abs/1611.04076
    """
    ...
    def _prepare_model(self, input_dim):
        ...
        self.discriminator.compile(
            loss="mse", optimizer=self._get_optimizer(), metrics=["accuracy"]
        )
        ...
        self.GANmodel.compile(loss="mse", optimizer=self._get_optimizer())
