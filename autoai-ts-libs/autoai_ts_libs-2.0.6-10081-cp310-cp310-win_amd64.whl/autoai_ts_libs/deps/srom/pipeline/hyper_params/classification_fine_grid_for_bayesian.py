...
PARAM_GRID["bernoullinb__alpha"] = (1e-3, 100.0)
PARAM_GRID["bernoullinb__fit_prior"] = [True, False]
PARAM_GRID["bernoullinb__binarize"] = (0.0, 1.0)
...
PARAM_GRID["multinomialnb__alpha"] = (1e-3, 100.0)
...
PARAM_GRID["decisiontreeclassifier__max_depth"] = (1, 15)
PARAM_GRID["decisiontreeclassifier__min_samples_split"] = (2, 20)
PARAM_GRID["decisiontreeclassifier__min_samples_leaf"] = (1, 20)
...
PARAM_GRID["decisiontreeclassifier__min_impurity_decrease"] = (0.0, 0.005)
...
PARAM_GRID["extratreesclassifier__n_estimators"] = (10, 500)
...
PARAM_GRID["extratreesclassifier__min_samples_split"] = (2, 20)
PARAM_GRID["extratreesclassifier__min_samples_leaf"] = (1, 20)
...
PARAM_GRID["randomforestclassifier__n_estimators"] = (10, 500)
PARAM_GRID["randomforestclassifier__criterion"] = ["gini", "entropy"]
PARAM_GRID["randomforestclassifier__min_samples_split"] = (2, 20)
PARAM_GRID["randomforestclassifier__min_samples_leaf"] = (1, 20)
...
PARAM_GRID["randomforestclassifier__min_impurity_decrease"] = (0.0, 0.005)
...
PARAM_GRID["gradientboostingclassifier__n_estimators"] = (10, 500)
PARAM_GRID["gradientboostingclassifier__learning_rate"] = (1e-3, 100.0)
PARAM_GRID["gradientboostingclassifier__subsample"] = (0.05, 1)
PARAM_GRID["gradientboostingclassifier__min_samples_split"] = (2, 20)
PARAM_GRID["gradientboostingclassifier__min_samples_leaf"] = (1, 20)
PARAM_GRID["gradientboostingclassifier__max_depth"] = (1, 10)
PARAM_GRID["gradientboostingclassifier__min_impurity_decrease"] = (0.0, 0.005)
...
PARAM_GRID["kneighborsclassifier__n_neighbors"] = (1, 100)
...
PARAM_GRID["linearsvc__tol"] = (1e-5, 1e-1)
PARAM_GRID["linearsvc__C"] = (1e-4, 25.0)
...
PARAM_GRID["logisticregression__C"] = (1e-4, 25.0)
...
PARAM_GRID["xgbclassifier__n_estimators"] = (10, 500)
PARAM_GRID["xgbclassifier__max_depth"] = (1, 50)
PARAM_GRID["xgbclassifier__learning_rate"] = (1e-3, 100.0)
PARAM_GRID["xgbclassifier__subsample"] = (0.05, 1)
PARAM_GRID["xgbclassifier__min_child_weight"] = (1, 20)
# PARAM_GRID['xgbclassifier__nthread'] = [1]
PARAM_GRID["xgbclassifier__gamma"] = (0.0, 0.51)
PARAM_GRID["xgbclassifier__colsample_bylevel"] = [1, 2]
PARAM_GRID["xgbclassifier__colsample_bytree"] = [1, 2]
...
PARAM_GRID["sgdclassifier__alpha"] = (0.000001, 0.01)
PARAM_GRID["sgdclassifier__learning_rate"] = ["constant", "optimal", "invscaling"]
PARAM_GRID["sgdclassifier__fit_intercept"] = [True, False]
PARAM_GRID["sgdclassifier__l1_ratio"] = (0.0, 1.0)
PARAM_GRID["sgdclassifier__eta0"] = (0.01, 100.0)
PARAM_GRID["sgdclassifier__power_t"] = (0.0, 100.0)
...
PARAM_GRID["svc__coef0"] = (0.0, 100.0)
...
PARAM_GRID["mlpclassifier__alpha"] = (0.0001, 0.1)
...
PARAM_GRID["passiveaggressiveclassifier__C"] = (0.000001, 100.0)
...
PARAM_GRID["adaboostclassifier__learning_rate"] = (0.01, 100.0)
PARAM_GRID["adaboostclassifier__n_estimators"] = (10, 500)
PARAM_GRID["adaboostclassifier__algorithm"] = ["SAMME.R", "SAMME"]
PARAM_GRID["adaboostclassifier__max_depth"] = (1, 15)
...
PARAM_GRID["lineardiscriminantanalysis__shrinkage"] = (0.01, 0.99)
# PARAM_GRID['lineardiscriminantanalysis__shrinkage_factor'] = [0,0.2,0.5,0.7,0.9,1.0]
PARAM_GRID["lineardiscriminantanalysis__n_components"] = (1, 250)
PARAM_GRID["lineardiscriminantanalysis__tol"] = (1e-5, 1e-1)

# QDA
# https://github.com/automl/auto-sklearn/blob/master/autosklearn/pipeline/components/classification/qda.py
PARAM_GRID["quadraticdiscriminantanalysis__reg_param"] = (0.0, 1.0)
...
PARAM_GRID["gaussianprocessclassifier__kernel"] = [None, ker_rbf, ker_rq, ker_expsine]
...
PARAM_GRID["gaussianprocessclassifier__max_iter_predict"] = (50, 150)
PARAM_GRID["gaussianprocessclassifier__random_state"] = [0]

# RidgeClassifier
PARAM_GRID["ridgeclassifier__alpha"] = (0, 1)
PARAM_GRID["ridgeclassifier__kernel"] = ["rbf", "linear"]
PARAM_GRID["ridgeclassifier__gamma"] = (1e-4, 1e-3)
PARAM_GRID["ridgeclassifier__C"] = (1, 1000)
...
# BaggingClassifier
PARAM_GRID["baggingclassifier__n_estimators"] = (10, 100)
PARAM_GRID["baggingclassifier__max_samples"] = (0.2, 1.0)
PARAM_GRID["baggingclassifier__max_features"] = (0.2, 1.0)

# NuSVC
PARAM_GRID["nusvc__nu"] = (0.1, 1.0)
PARAM_GRID["nusvc__kernel"] = ["linear", "poly", "rbf", "sigmoid"]
PARAM_GRID["nusvc__shrinking"] = [True, False]

# feature processing
PARAM_GRID["nmf__l1_ratio"] = (0, 1)
PARAM_GRID["nmf__tol"] = (1e-5, 1e-1)
PARAM_GRID["nmf__n_components"] = (3, 10)

# pca
PARAM_GRID["pca__svd_solver"] = ["auto", "full", "randomized"]
PARAM_GRID["pca__n_components"] = (3, 5)

# fastica
PARAM_GRID["fastica__n_components"] = (3, 10)
...
PARAM_GRID["kernelpca__n_components"] = (3, 10)
PARAM_GRID["kernelpca__coef0"] = (-1.0, 1.0)
PARAM_GRID["kernelpca__gamma"] = (0.0001, 2.0)
PARAM_GRID["kernelpca__degree"] = (2, 5)

# Nystroem
PARAM_GRID["nystroem__kernel"] = ["poly", "rbf", "sigmoid", "cosine"]
PARAM_GRID["nystroem__n_components"] = (5, 20)
PARAM_GRID["nystroem__gamma"] = (0.0001, 1.0)
PARAM_GRID["nystroem__degree"] = (2, 5)

# selectkbest
PARAM_GRID["selectkbest__k"] = (3, 20)

# variancethreshold
PARAM_GRID["variancethreshold__threshold"] = (0.0, 0.1)

# lowvariancefeatureelimination
PARAM_GRID["lowvariancefeatureelimination__var_threshold_value"] = (0.0, 0.1)

# feature post processing
PARAM_GRID["kbinsdiscretizer__n_bins"] = (3, 9)
...
PARAM_GRID["randomtreesembedding__n_estimators"] = (10, 100)
PARAM_GRID["randomtreesembedding__max_depth"] = (2, 10)
PARAM_GRID["randomtreesembedding__min_samples_split"] = (2, 20)
PARAM_GRID["randomtreesembedding__min_samples_leaf"] = (2, 20)

# selectpercentile
from sklearn.feature_selection import f_regression, mutual_info_regression

PARAM_GRID["selectpercentile__percentile"] = (1, 90)
PARAM_GRID["selectpercentile__score_func"] = [f_regression, mutual_info_regression]

# truncated SVD
PARAM_GRID["truncatedsvd__n_components"] = (2, 10)

# feature agglomeration
PARAM_GRID["featureagglomeration__n_clusters"] = (2, 50)
...
PARAM_GRID["rbfsampler__gamma"] = (0.00001, 1.0)
PARAM_GRID["rbfsampler__n_components"] = (50, 200)

PARAM_GRID["skewedchi2sampler__n_components"] = (50, 200)

PARAM_GRID["sparsepca__n_components"] = (5, 10)
PARAM_GRID["sparsepca__alpha"] = (0.2, 1.0)
PARAM_GRID["sparsepca__ridge_alpha"] = (0.01, 1.0)
PARAM_GRID["sparsepca__method"] = ["lars", "cd"]

PARAM_GRID["isomap__n_neighbors"] = (2, 10)
PARAM_GRID["isomap__n_components"] = (2, 10)
PARAM_GRID["isomap__eigen_solver"] = ["auto", "arpack", "dense"]
PARAM_GRID["isomap__path_method"] = ["auto", "FW", "D"]

PARAM_GRID["locallylinearembedding__n_neighbors"] = (2, 10)
PARAM_GRID["locallylinearembedding__n_components"] = (2, 10)
PARAM_GRID["locallylinearembedding__reg"] = (0.001, 0.1)
PARAM_GRID["locallylinearembedding__eigen_solver"] = ["auto", "arpack", "dense"]

PARAM_GRID["mds__n_components"] = (2, 10)
PARAM_GRID["mds__metric"] = [True, False]

PARAM_GRID["spectralembedding__n_components"] = (2, 10)
...
PARAM_GRID["tsne__n_components"] = (2, 10)
PARAM_GRID["tsne__learning_rate"] = (10.0, 1000.0)

PARAM_GRID["selectfrommodel__extratreesregressor__n_estimators"] = (10, 100)
PARAM_GRID["selectfrommodel__extratreesregressor__criterion"] = [
    "mse",
    "friedman_mse",
    "mae",
]
PARAM_GRID["selectfrommodel__extratreesregressor__max_features"] = (0.1, 1.0)
PARAM_GRID["selectfrommodel__extratreesregressor__min_samples_split"] = (2, 20)
PARAM_GRID["selectfrommodel__extratreesregressor__min_samples_leaf"] = (1, 20)
