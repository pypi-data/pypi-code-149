...
"""
.. module:: decomposition_imputers
   :synopsis: decomposition_imputers.

.. moduleauthor:: SROM Team
"""

from sklearn.impute import SimpleImputer
from autoai_ts_libs.deps.srom.imputation.base import DecompositionImputer
...
class NMFImputer(DecompositionImputer):
    """
    Imputer using NMF. 
    Choose the default of MinMaxScaler scaler to ensure the input dataset values not having negative
    """
