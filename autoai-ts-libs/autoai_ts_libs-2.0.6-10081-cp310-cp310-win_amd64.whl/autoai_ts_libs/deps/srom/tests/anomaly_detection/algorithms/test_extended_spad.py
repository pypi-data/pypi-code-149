"""Unit test cases for testing extended_spad class"""
import unittest
import numpy as np
import pandas as pd
import copy
...
class TestExtendedSPAD(unittest.TestCase):
    """Test methods in ExtendedSPAD class"""
    ...
    def test_fit_method(self):
        ...
        spad = ExtendedSPAD()
        fitted_spad = spad.fit(test_class.numpy_array)
        spad.anomaly_score(test_class.numpy_array)
