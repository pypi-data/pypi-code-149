...
from autoai_ts_libs.deps.srom.optimization import OptimizationSpark
...
class TestOptimizationSpark(unittest.TestCase):
    """Test class for OptimizationSpark class"""
    ...
    def test_predict_method(self):
        ...
        objective_function = TestOptimizationSpark.objective_function
    ...
    def test_optimization_with_smaller_is_better(self):
        ...
        pipelines_dict = test_class.pipelines_dict
        data_for_recommendations = test_class.data_for_recommendations
        objective_function = TestOptimizationSpark.reverse_objective_function
    ...
    def test_with_wrong_num_nodes(self):
        """Test predict method with wrong num_nodes"""
        test_class = self.__class__
        param_grid = test_class.param_grid
        pipelines_dict = test_class.pipelines_dict
        objective_function = TestOptimizationSpark.objective_function
    ...
    def test_with_wrong_num_cores_per_node(self):
        """Test predict method with wrong num_cores_per_node"""
        test_class = self.__class__
        param_grid = test_class.param_grid
        pipelines_dict = test_class.pipelines_dict
        objective_function = TestOptimizationSpark.objective_function
        ...
        self.assertRaises(
            ...
            param_grid,
            pipelines_dict,
            num_cores_per_node=1.5,
        )

    def test_with_num_nodes_and_num_cores_per_node(self):
        """Test predict method with different num_nodes and num_cores_per_node than default"""
        test_class = self.__class__
        param_grid = test_class.param_grid
        pipelines_dict = test_class.pipelines_dict
        data_for_recommendations = test_class.data_for_recommendations
