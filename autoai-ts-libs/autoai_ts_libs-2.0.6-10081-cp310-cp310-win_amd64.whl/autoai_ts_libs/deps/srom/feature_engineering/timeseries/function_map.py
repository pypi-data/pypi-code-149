...
from .functions import (
    check_single_dimensional_array,
    remove_nan_single_dimensional_array,
    remove_zero_single_dimensional_array,
    mean,
    minimum,
    sum_values,
    maximum,
    ...
    calculate_wavelet_features_for_band,
    get_Haar_Wavelet,
    get_symbolicaggregation,
    quantile_25,
    quantile_75,
    quantile_range,
    rate_of_change,
...
MAPPING = {
    "check_single_dimensional_array": check_single_dimensional_array,
    "remove_nan_single_dimensional_array": remove_nan_single_dimensional_array,
    "remove_zero_single_dimensional_array": remove_zero_single_dimensional_array,
    "sum_values": sum_values,
    "minimum": minimum,
    "maximum": maximum,
    "kurtosis": kurtosis,
    "quantile": quantile,
    "calculate_wavelet_features_for_band": calculate_wavelet_features_for_band,
    "get_Haar_Wavelet": get_Haar_Wavelet,
    "get_symbolicaggregation": get_symbolicaggregation,
    "mean": "mean",
    "max": "max",
    "min": "min",
    "median": "median",
