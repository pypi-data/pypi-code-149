...
from autoai_ts_libs.deps.srom.wml.wrappers.cloud.scoring import WMLScorer as TheRealScorer


class WMLScorer(TheRealScorer):
    """Legacy class to prevent existing uses from breaking.
    Please use srom.wml.wrappers.cloud.scoring.WMLScorer instead."""

    def __init__(self):
        super(WMLScorer, self).__init__()
        print("WARN: please use srom.wml.wrappers.cloud.scoring.WMLScorer instead.")
