                ...
                if ('arima' == self.algorithm.lower() or
                    ...
                    while (not model_initialized) and itr < 5:
                        ...
                        try:
                            ...
                            # print ("MODEL TRAINING STATUS ARIMA=========",model_initialized," INIT SIZE==",arima_min_train_size,
                            #        ' Lenght == ', vals_df_array[col].tolist()[0],vals_df_array[col].tolist()[-1])
                            #print(vals_df_array[col].tolist())
                        except  BaseException as e:
                            # er = str(e)
                            # raise (Exception(er))
